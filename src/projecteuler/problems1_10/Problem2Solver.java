 ...
 */
public class Problem2Solver extends Problem {
		
	public Problem2Solver() {
		super(2, "By considering the terms in the Fibonacci sequence whose values do not exceed four million, find the sum of the even-valued terms.", 4613732L);
	}
